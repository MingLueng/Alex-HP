...
(function ($) {
  ...
  // chạy đúng trang có section .contact-heading
   var $root = $('.contact-heading-info').closest('.about');
  ...
  var CONTACT_I18N = {
    ja: {
      leftHTML:
        '枠にとらわれない <br>創造力で<br>未来をデザイン<br>',
      info: 'お問い合わせ',
      heading: '接触',
      // nếu muốn đổi ảnh nền theo ngôn ngữ, chỉnh ở đây
      bgs: [
        "../image/レイヤー 853.png",
        "../image/レイヤー 851.png"
      ]
    ...
    vi: {
      leftHTML:
        'Vượt khỏi khuôn khổ,<br>bằng sức sáng tạo<br>để thiết kế tương lai<br>',
      info: 'Liên hệ',
      heading: 'Liên hệ',
      bgs: [
        "../image/レイヤー 853.png",
    ...
    en: {
      leftHTML:
        'Design the future<br>with creativity<br>beyond boundaries<br>',
      info: 'Contact',
      heading: 'CONTACT',
      bgs: [
        "../image/レイヤー 853.png",
